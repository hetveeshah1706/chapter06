...
@Component({
  selector: 'app-emulated-parent',
  templateUrl: './emulated-parent.component.html',
  styleUrls: ['./emulated-parent.component.css'],
  encapsulation:ViewEncapsulation.Emulated
})
export class EmulatedParentComponent implements OnInit {
  value:string="Mobile";
  allProduct:product[]=[
